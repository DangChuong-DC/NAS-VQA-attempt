...
from cfgs.train_cfgs import Cfgs
from Properties.exec import Execution
...
def parse_args():
    ...
    parser.add_argument('--DROP_R', dest='DROPOUT_R',
                      help='dropout rate',
                      type=float)

    parser.add_argument('--LR_DEC_EPO', dest='LR_DECAY_EPOCH',
                      help='epoch at which to decay learning rate',
                      type=str)
    ...
    parser.add_argument('--ARCH_NAME', dest='ARCH_NAME',
                        help='name of chosen architecture from genotypes file',
                        type=str)
