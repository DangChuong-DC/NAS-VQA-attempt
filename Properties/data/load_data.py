...
from Properties.data.data_utils import img_feat_path_load, img_feat_load, ques_load, tokenize, ans_stat
from Properties.data.data_utils import proc_img_feat, proc_ques, proc_ans
...
class DataSet(Data.Dataset):
    def __init__(self, __C):
        ...
        self.ans_to_ix, self.ix_to_ans = ans_stat('Properties/data/answer_dict.json')
