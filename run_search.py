...
from cfgs.search_cfgs import S_Cfgs
from Properties.exec_search import Search_Execution
...
def parse_args():
    ...
    parser.add_argument('--AR_LR', dest='ARCH_LR',
                        help='learning rate for architecture paramters',
                        type=float)

    parser.add_argument('--AR_WD', dest='ARCH_W_DECAY',
                        help='weight decay for architecture parameters update',
                        type=float)
...
if __name__ == '__main__':
    ...
    execution = Search_Execution(__C)
