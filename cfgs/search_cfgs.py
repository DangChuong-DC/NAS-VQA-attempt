...
class S_Cfgs(PATH):
    def __init__(self):
        ...
        self.TRAIN_SPLIT = 'train'   ### default 'train+val+vg'
        ...
        # RNN input dropout rate
        self.RNN_INP_DR_R = 0.1

        # RNN hidden dropout rate
        self.RNN_HID_DR_R = 0.1
        ...
        self.DROPOUT_R = 0.1
        # Mask-dropout rate (0.0 indicating non-utilization)
        self.MASK_DROP_R = 0.1

        # MLP size in node gating layers
        self.GATE_MLP_SIZE = 512
        ...
        # Affine argument for Layer Normalization Layers
        self.NORM_AFF = False
