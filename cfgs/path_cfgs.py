...
class PATH:
    def __init__(self):
        ...
        self.DATASET_PATH = '/beegfs/anhcda/VQA/data/vqa/'

        # bottom up features root path
        self.FEATURE_PATH = '/beegfs/anhcda/VQA/data/coco_extract/'
    ...
    def init_path(self):
        ...
        self.CKPTS_PATH = '/beegfs/anhcda/VQA/ckpts/'   ### default: './ckpts/'
        ...
        if 'ckpts' not in os.listdir('/beegfs/anhcda/VQA/'):   ### default: './'
            os.mkdir('/beegfs/anhcda/VQA/ckpts')   ### default: './ckpts'
